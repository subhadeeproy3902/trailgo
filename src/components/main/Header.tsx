...
type DropdownState = {
  isActive: boolean;
  idx: null | number; // Allow idx to be either null or a number
};
...
export default function Header() {
  ...
  return (
    <>
      <nav
        className={`relative z-20 bg-gray-50 w-full md:static md:text-sm md:border-none ${
      ...
      >
        <div className="items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
          ...
          >
            <ul className="items-center space-y-6 md:flex md:space-x-6 md:space-y-0 justify-between">
              <div className="flex flex-1 justify-center gap-12 flex-col md:flex-row">
                      ...
                      dropdownState.isActive ? (
                        <div className="mt-6 inset-x-0 top-20 w-full md:absolute md:border-y md:shadow-md md:mt-0">
                          <ul className="max-w-screen-xl mx-auto grid items-center gap-6 md:p-8 md:grid-cols-2 lg:grid-cols-3">
                            {(Array.isArray(item?.navs) ? item.navs : []).map(
                              (dropdownItem, idx) => (
                                <li key={idx}>
